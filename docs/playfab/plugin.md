...
Live tests require a dedicated sandbox PlayFab title plus a pre-existing custom id. All three test tiers run unconditionally; supply the required parameters:
