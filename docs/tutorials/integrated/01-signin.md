...
The integrated-track reference implementation lives in [`sample/tutorial_integrated/`](../../../sample/tutorial_integrated/README.md).
Open the matching scene and compare if your project drifts:

- Scene: [`sample/tutorial_integrated/i01_signin.tscn`](../../../sample/tutorial_integrated/i01_signin.tscn)
- Script: [`sample/tutorial_integrated/i01_signin.gd`](../../../sample/tutorial_integrated/i01_signin.gd)
- Autoload introduced here: [`sample/tutorial_integrated/autoload/auth.gd`](../../../sample/tutorial_integrated/autoload/auth.gd)
...
Continue to [Integrated Tutorial 2 — Integration tech demo](02-tech-demo.md).
