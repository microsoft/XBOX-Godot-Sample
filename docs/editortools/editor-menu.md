...
`gdkpkg` runner documented in [Editor Tools Plugin](plugin.md).

The menu is assembled by
`addons\godot_gdk_editortools\editor\gdk_editortools_plugin.gd`. It contains
...
- Enable the `godot_gdk_editortools` addon in the Godot editor.
...
**Deeper docs:** Continue with [Editor Tools Plugin](plugin.md) for the headless
...
**Deeper docs:** See [Editor Tools Plugin](plugin.md#verbs) for the
...
[Editor Tools Plugin](plugin.md#verbs).
...
and `terminate` verbs in [Editor Tools Plugin](plugin.md#verbs), plus the
...
**Deeper docs:** Pair it with [Editor Tools Plugin](plugin.md) for this addon's
