#ifndef XBOX_ACTIVATION_H
#define XBOX_ACTIVATION_H
...
//
// Coexistence note: XboxActivation is the sole owner of the native activation
...
// registrations.
class XboxActivation : public RefCounted {
    GDCLASS(XboxActivation, RefCounted);
...
VARIANT_ENUM_CAST(godot::XboxActivation::ActivationType);

#endif // XBOX_ACTIVATION_H
