// xbox_request_parsing.h — Engine-free seam for GDK request-input parsing.
//
...
//
// The helpers use only godot-cpp built-in types plus XboxResult (which is itself
...
#ifndef XBOX_REQUEST_PARSING_H
#define XBOX_REQUEST_PARSING_H

#include <cstddef>
#include <cstdint>
#include <vector>

// xbox_result.h must precede the godot-cpp variant headers below: it includes
...
// write it to *r_value. Returns an XboxResult describing success or the failure.
...
// buffer p_buffer of capacity p_buffer_size. Returns an XboxResult describing
