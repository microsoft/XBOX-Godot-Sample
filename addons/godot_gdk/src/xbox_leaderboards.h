#ifndef XBOX_LEADERBOARDS_H
#define XBOX_LEADERBOARDS_H
...
class XboxLeaderboardColumn : public RefCounted {
    GDCLASS(XboxLeaderboardColumn, RefCounted);
...
class XboxLeaderboardRow : public RefCounted {
    GDCLASS(XboxLeaderboardRow, RefCounted);
...
class XboxLeaderboard : public RefCounted {
    GDCLASS(XboxLeaderboard, RefCounted);
...
class XboxLeaderboards : public RefCounted {
    GDCLASS(XboxLeaderboards, RefCounted);
    ...
    Ref<XboxLeaderboard> _cache_leaderboard(const Ref<XboxLeaderboard> &p_leaderboard);
...
public:
    ...
    Signal get_leaderboard_async(const Ref<XboxUser> &p_user, const String &p_stat_name, int64_t p_max_items = 25);
    Signal get_leaderboard_around_user_async(const Ref<XboxUser> &p_user, const String &p_stat_name, int64_t p_max_items = 25);
    Signal get_social_leaderboard_async(const Ref<XboxUser> &p_user, const String &p_stat_name, int64_t p_max_items = 25);
    Signal get_next_page_async(const Ref<XboxLeaderboard> &p_leaderboard);
    Ref<XboxLeaderboard> get_cached_leaderboard(const String &p_stat_name) const;

    Ref<XboxLeaderboard> cache_leaderboard_internal(const Ref<XboxLeaderboard> &p_leaderboard);
    void on_user_removed(const Ref<XboxUser> &p_user);
};

} // namespace godot

#endif // XBOX_LEADERBOARDS_H
