// Pure HRESULT formatting helpers extracted from xbox_result.cpp.
//
// These free functions live in the xbox_internal:: namespace and are
...
#ifndef XBOX_RESULT_CODES_INTERNAL_H
#define XBOX_RESULT_CODES_INTERNAL_H
...
// This is the public-API-shape helper that XboxResult::format_hresult forwards to.
godot::String format_hresult_string(HRESULT p_hresult);

// Build the standard "<action> (HRESULT 0xXXXXXXXX)" message string used by
// XboxResult::hresult_error. If action is empty the leading "<action> " is omitted.
godot::String format_hresult_message(const godot::String &p_action, HRESULT p_hresult);

// Fallback resolver for the "code" field on an XboxResult: returns p_provided
...
#endif // XBOX_RESULT_CODES_INTERNAL_H
