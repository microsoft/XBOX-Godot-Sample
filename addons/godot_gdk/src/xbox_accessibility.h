#ifndef XBOX_ACCESSIBILITY_H
#define XBOX_ACCESSIBILITY_H
...
class XboxClosedCaptionProperties : public RefCounted {
    GDCLASS(XboxClosedCaptionProperties, RefCounted);
...
class XboxAccessibility : public RefCounted {
    GDCLASS(XboxAccessibility, RefCounted);
...
public:
    ...
    Ref<XboxResult> query_closed_caption_properties() const;
    Ref<XboxResult> set_closed_caption_enabled(bool p_enabled) const;
    Ref<XboxResult> query_high_contrast_mode() const;
    String get_high_contrast_mode_name(HighContrastMode p_mode) const;
};

} // namespace godot

VARIANT_ENUM_CAST(godot::XboxClosedCaptionProperties::FontEdgeAttribute);
VARIANT_ENUM_CAST(godot::XboxClosedCaptionProperties::FontStyle);
VARIANT_ENUM_CAST(godot::XboxAccessibility::HighContrastMode);

#endif // XBOX_ACCESSIBILITY_H
