...
public sealed class XboxUserProfile : XboxObject
{
    internal XboxUserProfile(GodotObject o) : base(o) { }
    public static XboxUserProfile From(GodotObject o) => o == null ? null : new XboxUserProfile(o);
