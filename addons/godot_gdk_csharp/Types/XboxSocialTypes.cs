...
public sealed class XboxSocialFilter : XboxObject
{
    internal XboxSocialFilter(GodotObject o) : base(o) { }
    public static XboxSocialFilter From(GodotObject o) => o == null ? null : new XboxSocialFilter(o);
...
public sealed class XboxSocialGroup : XboxObject
{
    internal XboxSocialGroup(GodotObject o) : base(o) { }
    public static XboxSocialGroup From(GodotObject o) => o == null ? null : new XboxSocialGroup(o);

    public XboxUser LocalUser => XboxUser.From(GetObject("local_user"));
...
public sealed class XboxSocialUser : XboxObject
{
    internal XboxSocialUser(GodotObject o) : base(o) { }
    public static XboxSocialUser From(GodotObject o) => o == null ? null : new XboxSocialUser(o);
    ...
    public XboxPresenceRecord Presence => XboxPresenceRecord.From(GetObject("presence"));
