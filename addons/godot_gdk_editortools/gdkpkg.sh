#!/usr/bin/env bash
# ============================================================================
#  gdkpkg.sh — Bash shell forwarder for the godot_gdk_editortools runner.
#
#  Usage:
#      addons/godot_gdk_editortools/gdkpkg.sh <verb> [--flag value] [...]
#
#  Behaviour:
...
exec "$godot_exe" --headless --path "$project_path" \
    -s res://addons/godot_gdk_editortools/run.gd -- "${forward_args[@]}"
