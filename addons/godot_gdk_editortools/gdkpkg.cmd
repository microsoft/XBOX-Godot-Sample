...
rem ============================================================================
rem  gdkpkg.cmd — Windows shell forwarder for the godot_gdk_editortools runner.
rem
rem  Usage:
rem      addons\godot_gdk_editortools\gdkpkg.cmd <verb> [--flag value] [...]
rem
rem  Behaviour:
...
rem      EditorToolsResult.exit_code).
rem ============================================================================
