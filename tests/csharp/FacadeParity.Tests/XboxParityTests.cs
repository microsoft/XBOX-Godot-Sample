...
public class XboxParityTests
{
    private static readonly Assembly Facade = typeof(GodotXbox.Xbox).Assembly;
    ...
    {
        System.Type csharpType = ParityChecker.ResolveType(Facade, nativeClass, "GDK", typeof(GodotXbox.Xbox));
