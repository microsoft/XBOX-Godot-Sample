...
const ConfigImportPluginScript = preload("res://addons/godot_gdk_packaging/editor/config_import_plugin.gd")

const SCRIPT_PATH := "res://addons/godot_gdk_packaging/editor/config_import_plugin.gd"
...
func test_fixture_inventory_present() -> void:
	# Every fixture this test suite (and `test_packaging_content_preparer.gd`)
