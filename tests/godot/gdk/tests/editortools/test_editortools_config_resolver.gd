extends GutTest
## GUT coverage for `core/editortools_config.gd` — pins the precedence chain
...
const _FIXTURE_DIR := "user://test_editortools_config_resolver"
...
func test_defaults_apply_when_nothing_is_supplied() -> void:
	var resolved: Dictionary = EditorToolsConfig.resolve({}, _project_dir(), "", "")
