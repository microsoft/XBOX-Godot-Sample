extends GutTest
## GUT coverage for the lifecycle contract of `gdk_editortools_plugin.gd`.
##
...
const PLUGIN_SCRIPT_PATH := "res://addons/godot_gdk_editortools/editor/gdk_editortools_plugin.gd"
...
# Tiny harness mirroring the structure of `gdk_editortools_plugin._enter_tree`
