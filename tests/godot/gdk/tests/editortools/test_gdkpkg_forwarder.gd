...
func test_posix_forwarder_uses_arrays_without_eval() -> void:
	var source: String = _read_text(ProjectSettings.globalize_path("res://addons/godot_gdk_editortools/gdkpkg.sh"))
...
func test_windows_forwarder_discovery_order_is_env_sample_cwd_then_path() -> void:
	var source: String = _read_text(ProjectSettings.globalize_path("res://addons/godot_gdk_editortools/gdkpkg.cmd"))
...
func test_windows_forwarder_prefers_env_over_path_and_preserves_special_args() -> void:
	...
	_copy_file(ProjectSettings.globalize_path("res://addons/godot_gdk_editortools/gdkpkg.cmd"), forwarder_path)
	...
	assert_eq(_read_lines(env_capture_path), [
		...
		project_path,
		"-s",
		"res://addons/godot_gdk_editortools/run.gd",
		"--",
		"pack",
		"--source-dir",
		source_dir,
