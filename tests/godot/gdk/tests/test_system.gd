...
func test_system_surface_and_validation_paths() -> void:
	...
	assert_not_null(pre_init_scid, "get_service_configuration_id() returns XboxResult before initialize")
	...
	assert_not_null(title_id_result, "get_title_id() returns XboxResult")
	...
	assert_not_null(title_id_hex_result, "get_title_id_hex() returns XboxResult")
	...
	assert_not_null(sandbox_result, "get_sandbox_id() returns XboxResult")
	...
	assert_not_null(init_result, "GDK.initialize() for system behavior returns XboxResult")
	if init_result == null:
		return

	var post_init_scid = system.get_service_configuration_id()
	assert_not_null(post_init_scid, "get_service_configuration_id() returns XboxResult after initialize attempt")
