...
##
## Asserts: `playfab/runtime/singleton_name` actually changes the Engine
## singleton name the `godot_playfab` GDExtension registers.
##
...
const OVERRIDE_SECTION := "playfab"
const OVERRIDE_KEY := "runtime/singleton_name"
const DEFAULT_SINGLETON_NAME := "PlayFab"
const RENAMED_SINGLETON_NAME := "PlayFabSingletonRenameProbe"
