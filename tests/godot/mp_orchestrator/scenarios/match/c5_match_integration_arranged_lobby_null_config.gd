...
const SCENARIO_ID: String = "match.integration.arranged_lobby_null_config"
const SCENARIO_NAME: String = "Arranged lobby omitted config uses defaults"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_match_integration_arranged_lobby_null_config(orch)
