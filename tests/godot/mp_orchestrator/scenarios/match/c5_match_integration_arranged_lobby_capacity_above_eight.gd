...
const SCENARIO_ID: String = "match.integration.arranged_lobby_capacity_above_eight"
const SCENARIO_NAME: String = "Arranged lobby supports capacity above eight"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_match_integration_arranged_lobby_capacity_above_eight(orch)
