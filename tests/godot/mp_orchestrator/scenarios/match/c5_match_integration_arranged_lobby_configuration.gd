...
const SCENARIO_ID: String = "match.integration.arranged_lobby_configuration"
const SCENARIO_NAME: String = "Arranged lobby honors explicit initialization"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_match_integration_arranged_lobby_configuration(orch)
