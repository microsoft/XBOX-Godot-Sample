...
const SCENARIO_ID: String = "lobby.update.post_update.typed_completion"
const SCENARIO_NAME: String = "Batched post_update_async completes as UPDATE_COMPLETED"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_update_post_update_typed_completion(orch)
