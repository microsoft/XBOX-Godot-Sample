...
const SCENARIO_ID: String = "lobby.update.search_properties"
const SCENARIO_NAME: String = "Search property update propagates to every member"
...
func run(orch) -> Dictionary:
	return await Flow.new().run_lobby_update_search_properties(orch)
